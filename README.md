...
Document Object Model, an organization chart created by a browser of a webpage.

2. What is an event?

Events notify of interesting things that have taken place.

3. What is an event listener?

An object that handles an event.

4. Why would we convert a NodeList into an Array?

To be able to manipulate items in NodeList like an array.

5. What is a component?

Components are reusable pieces of code that can be used to build elements.
